...
public class PolygonGroup { 
    ...
    private NodePol first, front, back;
    private NodePol size;
    ...
    public void add(Polygon pol) {
        // COMPLETAR 
        NodePol current = this.first;
        NodePol previous = null;
        int rc = -1;
        ...
        if (rc != 0){
            if (previous != null) {
                previous.setNext(new NodePol(s, current));
            }
            else this.first = new NodePol(s, current);
